...
class DeepLabV3PlusFusion(nn.Module):
    ...
    def forward(self, x):
        ...
        # ******************** Stage2 ********************
        # TODO
        x, stage2_mid = self.stage2(x)  # x[x0(B,32,H/4,W/4), x1(B,64,H/8,W/8)]
        # Stage2层的特征图
        stage2_features0 = x[0]
        stage2_features1 = x[1]
        ...
        # ******************** Stage3 ********************
        # TODO
        x, stage3_mid = self.stage3(x)
        # x[x0(B,32,H/4,W/4), x1(B,64,H/8,W/8), x2(B,128,H/16,W/16)]
        # Stage3层的特征图
        stage3_features0 = x[0]
        stage3_features1 = x[1]
        stage3_features2 = x[2]
        ...
        # ******************** Stage4 ********************
        # TODO
        x, stage4_mid = self.stage4(x)  # x[x0(B,32,H/4,W/4)] 所有分支上采样至(H/4,W/4)后逐像素点相加输出
        ...
        return Outputs(
            ...
            stage2_mid0=stage2_mid[0],
            stage2_mid1=stage2_mid[1],
            stage2_0=stage2_features0,
            stage2_1=stage2_features1,
            stage3_mid0=stage3_mid[0],
            stage3_mid1=stage3_mid[1],
            stage3_mid2=stage3_mid[2],
            stage3_0=stage3_features0,
            stage3_1=stage3_features1,
            stage3_2=stage3_features2,
            stage4_mid0=stage4_mid[0],
            stage4_mid1=stage4_mid[1],
            stage4_mid2=stage4_mid[2],
            stage4_mid3=stage4_mid[3],
