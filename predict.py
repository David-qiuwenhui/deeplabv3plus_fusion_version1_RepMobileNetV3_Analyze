...
pred_cfg = dict(
    ...
    # ---------- 多张图片预测 ----------
    dir_origin_path="./train_img",
    dir_save_path="train_img_mask/",
    # ---------- fps计算模式 ----------
...
def main(pred_cfg):
    ...
    if mode == "predict":
        ...
        r_image.save(pred_cfg["img_save_path"], quality=95)
        # r_image.show()
        ...
        for img_name in track(img_names):
            if img_name.lower().endswith(
                ...
                if pred_cfg["mix_type"] == 1:
                    ...
                    r_image.save(os.path.join(dir_save_path, img_name), quality=95)
